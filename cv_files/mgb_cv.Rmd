...
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Mark,
  "PhD Political Science", "2018-2021", "Queen Mary University of London", "supervised by Professor Philip Cowley and Dr Javier Sajuria, examined by Professor Shaun Bowler (UC Riverside) and Dr James Strong. Funded by a +3 ESRC studentship",
  "The Bandwagon Effect: How Popularity Information Affects Electoral Expectations and Voting Behaviour",  "Thesis title", "", "",
...
tribble(
  ...
  "Barnfield, M.", "2021", "Momentum Matters: The Dynamic Effect of Changes in Vote Intention Polls on Electoral Expectations", "Under Review",
  "Stöckli, S., Spälti, A. K., Phillips, J., Stoeckel, F., Barnfield, M., Thompson, J., Lyons, B., Mérola, V., Szewach, P., and Reifler, J.", "2021", "Which vaccine attributes foster vaccine uptake? A cross-country conjoint experiment", "Under Review",
...
# Professional service and research involvement
