...
tribble(
  ...
  "Zerback, T., Reinemann, C., and Barnfield, M.", "2021 (Under Review)", "Total Recall? Examining the accuracy of poll recall during an election campaign", "Mass Communication and Society"
) %>% 
...
tribble(
  ...
  "Teaching Associate", "POLM083: Introduction to Quantitative Methods (Postgraduate)", "2021", "Queen Mary University of London",
) %>% 
